...
> The recurrence interval plots are very similar out until about 20 years, then they start to diverge. This indicates a degree of stationarity, as anything smaller than a 20-year event is likely the same size now as it was 30-years ago. However, past 20 years is where there is some change and stationarity is not shown. The 30-year event for the first 30 years is the same size as the 50-year event for the full timeline, indicating potentially that large events are becoming more rare. This is backed up by the predictions for the 100-yr floods. The models predicted a 100-year flood about 1000cfs higher for the first 30 years than it was for the full timeframe, indicating that potentially this river is seeing reduced flows, reduced large precipitation events, and thus a smaller 100-year flood event now than was expected 30 years ago. Changing conditions are reducing this river's flow and frequency of large flood events. 
