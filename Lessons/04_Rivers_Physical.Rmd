...
EnoDischarge <- readNWISdv(siteNumbers = "02085070",
                     ...
                     startDate = "", 
                     endDate = "2021-09-30") # end of the water year
...
# specify USGS water year, other places use different ones (ie Aus)
...
#to convert to numeric need to convert to character then to numeric from factor
...
#lm means linear model (regression)
...
>Eno is not displaying stationary behavior, the later 30 years' floods are predicted to be larger than the previous 30 years' floods -> changing conditions
...
> The more recent, its a safer bet 
