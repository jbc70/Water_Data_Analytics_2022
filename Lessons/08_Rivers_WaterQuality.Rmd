...
Parameters of interest: google USGS parameter codes, locations
...
```{r}
#1
unique(NeuseWQ_processed$HydrologicCondition)
#google reorder factor levels

#2
ggplot(NeuseWQ_processed, aes(x = HydrologicCondition, y = Fecal))
```
